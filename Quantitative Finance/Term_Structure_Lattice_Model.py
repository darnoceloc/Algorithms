...
lattice = TSLM(r0, u, d, q, maturity, face_value)
print(lattice.zcb_price())

lattice3 = TSLM(r0, u, d, q, 4, 1)
print(lattice3.zcb_price())


print(lattice.zcb_price()/lattice3.zcb_price())

print(lattice.future_zcb_price(4))
print(lattice.us_call_zcb_price(6, 80))
print(lattice.swap_price(1, 0.045, 1000000))
print(lattice.swaption_price(1, 0.045, 5, 0, 1000000))
